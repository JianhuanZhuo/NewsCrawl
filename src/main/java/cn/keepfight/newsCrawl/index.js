!function t(e, a, i) {
    ...
    1: [function (t, e, a) {
        ...
        a.__esModule = !0, a.Fixed = function (t, e) {
            var a = e.other, i = e.top, n = void 0 === i ? 0 : i, o = void 0, r = void 0, s = void 0;
            setTimeout(function () {
                var e = $(t).offset();
                void 0 !== e && (r = $(t).height(), s = e.top, $(window).bind("scroll", function (e) {
                    o = $("#footer").offset().top;
                    var i = a && $("#" + a).height() || 0, l = $(this).scrollTop();
                    (!a || a && r < i) && l >= s ? o <= r + l ? $(t).css({
                        position: "absolute",
                        top: o - r - s - n
                    }) : $(t).css({position: "fixed", top: n}) : $(t).css({position: "relative", top: 0})
                }))
            }, 300)
        }
    }, {}], 2: [function (t, e, a) {
        ...
        a.Page = function () {
            function t() {
                ...
                var a = {threshold: 5, isLink: !1, linkTxt: "javascript:void(0);", pageBack: !1};
            ...
            return t.prototype.bind = function () {
                ...
                var a = this.opt, i = void 0, n = void 0, o = void 0, r = [], s = a.threshold;
                if (1 == e) return "";
                if (1 == t) i = "<li><span>1</span></li>"; else {
                    var l = a.linkTxt, c = a.linkTxt;
                ...
                if (r.push(i), e > 2) {
                    if ((n = t <= s - 2 || t == s && t == e ? 2 : e > s && e - t + 1 < s ? e - s + 1 : t - Math.floor((s - 1) / 2)) > 2 && r.push('<li><a href="javascript:void(0);">...</a></li>'), t <= s - 2) o = Math.min(s, e - 1); else {
                ...
                if (e > 1) {
                    if (e <= t) i = "<li><span>" + e + '</span></li>\n                      <li class="jump">跳到<input type="text" name="jumpPage" id="jumpPage" value="" />页</li>'; else {
                        var d = a.linkTxt, h = a.linkTxt;
        ...
        a.__esModule = !0, a.setCommRank = function (t, e, a) {
            $.ajax({
                ...
                if (e && e.data) {
                    var i = e.data, n = void 0, o = void 0, r = [], s = i.length;
                    if (s > 0) {
        ...
        "use strict";
        !function (t, e, a) {
            var i = document, n = i.getElementsByTagName("head")[0], o = i.createElement("script");
            ...
            $("#login .quickArea").eq(0).hover(function () {
            }, function () {
            })
        ...
        var n = t("./js/buildList"), o = t("./js/calendar"), r = t("../common/commRank/main"), s = t("../common/Fixed"),
            l = {
                today: new Date,
                curPage: 1,
                total: 1,
                ...
                isTitQuit: !1,
                footTop: 0
            }, c = [{site: "news", url: "//news.qq.com/"}, {site: "ent", url: "//ent.qq.com/"}, {
                site: "sports",
                url: "//sports.qq.com/"
            }, {site: "finance", url: "//finance.qq.com/"}, {site: "tech", url: "//tech.qq.com/"}, {
                site: "games",
                url: "//games.qq.com/"
            }, {site: "auto", url: "//auto.qq.com/"}, {site: "fashion", url: "//fashion.qq.com/"}, {
                site: "edu",
                url: "//edu.qq.com/"
            }, {site: "house", url: "//house.qq.com/"}, {site: "ru", url: "//ru.qq.com/"}, {
                site: "foxue",
                url: "//foxue.qq.com/"
            }, {site: "dao", url: "//dao.qq.com/"}], u = function () {
                var t = l.site;
                ...
                var a = new Date("2009/01/01"),
                    r = new o.GCalendar(document.getElementById("calendar"), t, e, function (t, e, a, o) {
                        (0, i.registerZone)({bossId: "1408", bossZone: "gd_time", url: window.location.href}, 1);
                        var r = e + "年" + a + "月" + o + "日";
                ...
                $.ajax({
                    ...
                    if (t && "0" === t.response.code && t.data && t.data.date) {
                        var e = void 0, a = void 0, i = void 0, o = t.data.date.split(/[- :]/);
        ...
        !function () {
            ...
            l.site = "fashion" == t ? "luxury" : t, t = l.site, u(), p(), h(l.cataNum), f(), "games" == t && (t = "gamezone"), (0, r.setCommRank)("#commRank", t), g(), (0, s.Fixed)("#right", {
                top: 15,
                other: "listInfo"
            }), (0, s.Fixed)("#siteNav", {top: 15, other: "listInfo"})
        }()
    }, {
        "../common/Fixed": 1,
        ...
        var i = t("../../common/Page/main"), n = t("./refresh"), o = new i.Page({
            pageBack: function (t) {
                r.curPage = t, u(r)
            }
        }), r = void 0, s = function (t) {
            ...
            var a = r = e, i = a.curPage, u = a.site, d = a.cata, h = a.mode, p = a.date;
            s(!0), d = "all" != d ? d : "", $.ajax({
                url: "//roll.news.qq.com/interface/cpcroll.php",
                data: {site: u, mode: h, cata: d, date: p, page: i},
                jsonpCallback: "rollback",
                dataType: "jsonp",
                success: function (e) {
                    if (e && "0" === e.response.code && e.data) {
                        var a = e.data, i = a.article_info, u = "";
                        u = 2 == h ? l(i) : c(i), $("#listInfo").html(u), s();
                        var d = a.page || 1, p = a.count || 1;
    ...
    }, {"../../common/Page/main": 2, "./refresh": 8}], 7: [function (t, e, a) {
        "use strict";
        a.__esModule = !0;
        ...
        a.GCalendar = function (t, e, a, n) {
            ...
            var r = this, s = function (t) {
                    ...
                    var a = document.createElement(t.tag || "div"), n = !!a.setAttribute;
                    ...
                    return t.html && (a.innerHTML = t.html), function (t, e) {
                        function a(t, e, a) {
                            if (t && "string" == typeof a) return e = e || "", a = a || "", t.style[e] = a, t
                        }

                        if (e) if ("string" == typeof e) for (var n, o = /\s?([a-z\-]*)\:\s?([^;]*);?/gi; null != (n = o.exec(e));) a(t, n[1], n[2]); else if ("object" == (void 0 === e ? "undefined" : i(e))) for (var r in e) a(t, r, e[r])
                    }(a, t.style), e && e.appendChild(a), a
                }, c = function (t) {
                    var t = Math.random, e = parseInt;
                    return Number(new Date).toString().substring(0, 9) + e(10 * t()) + e(10 * t())
                }(), u = this.clientDate, d = (u.getFullYear(), u.getMonth(), u.getDate(), this.startDate),
                h = d.getFullYear(), p = d.getMonth() + 1, f = d.getDate(),
            ...
            this.cur_year = h, this.cur_month = p, this.cur_date = d.getDate(), this.weekDay = ["日", "一", "二", "三", "四", "五", "六"], this.build = function (t) {
                ...
                var o = this.parseCalendarHeader(), r = this.parseCalendarWeekDay(),
                    s = this.parseCalendarDayList(i, e), u = l({id: "_CalendarHeader_" + c, cls: "CalendarHead"});
                u.appendChild(o);
                var d = l({id: "_CalendarCon_" + c, cls: "CalendarCon"});
                ...
                var n = l({tag: "table"}), o = l({tag: "tbody"}), s = l({tag: "tr"});
                s.setAttribute("valign", "top");
                for (var c, u, d, f = h + "年" + p + "月", g = ["&lt;&lt;", "&lt;", f, "&gt;", "&gt;&gt;"], m = ["上一年", "上一月", "", "下一月", "下一年"], v = ["btn", "btn", "", "btn", "btn"], b = [-12, -1, 0, 1, 12], y = 0; y < 5; y++) (c = l({tag: "td"})).setAttribute("title", m[y]), u = "a", 2 == y && (u = "h3", c.setAttribute("id", "_CalendarYear_")), (d = l({
                    tag: u,
                ...
                for (var t, e, a = this.weekDay, i = l({
                    tag: "table",
                    class: "week"
                }), n = l({tag: "tbody"}), o = l({tag: "tr"}), r = 0; r < a.length; r++) t = "", 0 == r && (t = "sunday"), r == a.length - 1 && (t = "saturday"), e = l({
                    tag: "th",
                    html: a[r],
                    cls: t
                }), o.appendChild(e);
                ...
                for (var i, n, s, u, d, g = t, m = e, v = 0, b = m.getFullYear(), y = m.getMonth() + 1, k = (m.getDay(), l({id: "_CalendarDayList_" + c})), x = l({tag: "table"}), $ = l({tag: "tbody"}), C = 0; C < 6; C++) {
                    i = l({tag: "tr"});
                    for (var D = 0; D < 7; D++) {
                        if (u = g[v++], n = l({tag: "td"}), u == f && this.cur_year == h && this.cur_month == p) s = l({
                            tag: "a",
                            html: this.cur_date,
                            href: "javascript:void(0);",
                            cls: "today"
                        }), this.isStatic || (s.attachEvent ? s.attachEvent("onclick", a(b, y < 10 ? "0" + y : y, u < 10 ? "0" + u : u, r)) : s.addEventListener && s.addEventListener("click", a(b, y < 10 ? "0" + y : y, u < 10 ? "0" + u : u, r), !1)), o = s; else if (u) if ((d = new Date(b, y - 1, u)) <= this.clientDate && d >= this.limitStartDate) {
                        ...
                        } else s = l({tag: "span", html: u}); else s = l({tag: ""});
        ...
        "use strict";
        a.__esModule = !0;
        var i = null, n = 60, o = 1, r = !1, s = !1, l = function t(e) {
        ...
        "use strict";
        a.__esModule = !0;
        var i = void 0, n = function () {
            void 0 !== i && i || (!(i = {}).exposure && (i.exposure = {}), !i.registerZone && (i.registerZone = {})), this.initExposure(), this.initRegister()
        };
        n.prototype = {
            constructor: n, initExposure: function () {
                var t = escape(location.href),
                    e = {BossId: 1604, Pwd: 0, sOp: "", iQQ: "", site: location.host, sBiz: "", sUrl: t};
                this.exposureData = $.extend(!0, e, i.exposure)
            }, initRegister: function () {
                var t = location.href, e = t.substring(7, t.indexOf(".qq.com")), a = {
                    BossId: 1408,
                    Pwd: 0,
                    sOp: "",
                    sBiz: "qq.com",
